...
export const TaskAlertManager = () => {
  ...
  useEffect(() => {
    ...
    const ackTasksStr = (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{} }).getItem(`ack_tasks_${userId}`) || '[]';
    const ackDueStr = (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{} }).getItem(`ack_due_${userId}`) || '[]';
    ...
    if (alert.type === 'new') {
      ...
      try {
        ...
        if (!ackTasks.includes(alert.taskId)) {
          ...
          (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{} }).setItem(`ack_tasks_${userId}`, JSON.stringify(ackTasks));
        }
      } catch (e) {
        (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{} }).setItem(`ack_tasks_${userId}`, JSON.stringify([alert.taskId]));
      }
    } else {
      const ackDueStr = (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{} }).getItem(`ack_due_${userId}`) || '[]';
      try {
        ...
        if (!ackDue.includes(alert.taskId)) {
          ...
          (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{} }).setItem(`ack_due_${userId}`, JSON.stringify(ackDue));
        }
      } catch (e) {
        (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{} }).setItem(`ack_due_${userId}`, JSON.stringify([alert.taskId]));
      }
    }
