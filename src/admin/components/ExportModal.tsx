...
export const ExportModal = ({
  ...
  const [lastExportInfo, setLastExportInfo] = useState(() => {
    try { return JSON.parse((typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{} }).getItem(LAST_EXPORT_KEY)); } catch { return null; }
  });
  ...
  const handleExport = useCallback(async () => {
    ...
    try {
      ...
      (typeof window !== 'undefined' ? localStorage : { getItem:()=>null, setItem:()=>{}, removeItem:()=>{} }).setItem(LAST_EXPORT_KEY, JSON.stringify(info));
